...
class AdminScreenController extends Controller
{
    ...
    public function store(StoreScreenRequest $request)
    {
        ...
        $data['default_url'] = 'https://wakeb-ads.azurewebsites.net/Adv-master/videos/Adv5dfa9add35b32.webm';
        $data['waiting_url'] = 'https://wakeb-ads.azurewebsites.net/Adv-master/videos/Adv5dfa9add35b32.webm';
