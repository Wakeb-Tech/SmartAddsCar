...
//        return view('client.advertisement.show')->with(['advertisement' => $advertisement]);
    ...
    {
        $advscreens = $advertisement->screens()->get();
        $advclasses = $advertisement->modelClasses()->get();
        $all_screen = Auth::user()->screens->toArray();
        $all_model = Auth::user()->package->models->all();
        return view('client.advertisement.edit')->with(['advertisement' => $advertisement,'advclasses'=>$advclasses,'advscreens'=>$advscreens,'models'=>$all_model, 'screens'=>$all_screen]);
    }
