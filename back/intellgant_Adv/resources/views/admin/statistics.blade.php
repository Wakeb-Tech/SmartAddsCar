            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="card card-default collapsed-card">
                        ...
                        <div class="card-body" style="display: none;">
                            <div class="row">
                                    <div class="col-md-12">
                                        <label for="user_id" class="col-form-label text-md-right">{{ __('user_id') }}</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <select class="form-control" id="user_id"  name="user_id" selected="{{ old('user_id') }}">
                                    ...
                                    <div class="col-md-6">
                                        <label for="screen_id" class="col-form-label text-md-right">{{ __('Screens') }}</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <select class="form-control" id="screen_id"  name="screen_id" selected="{{ old('screen_id') }}">
                                            <option value="-1">All Screen</option>
                                        </select>&nbsp;&nbsp;&nbsp;
                                    </div>
                                    <div class="col-md-6">
                                        <label for="advertisement_id" class="col-form-label text-md-right">{{ __('Advertisements ') }}</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <select class="form-control" id="advertisement_id"  name="advertisement_id" selected="{{ old('advertisement_id') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Statistics (Date With Smilling,number of people and time in front camira)</h3> &nbsp;&nbsp;&nbsp;&nbsp;
                            </div>
                            <!-- /.card-header -->
