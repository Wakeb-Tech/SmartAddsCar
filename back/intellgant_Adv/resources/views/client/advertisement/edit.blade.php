                                            ...
                                            @if(count($model->classes) > 0)
                                                @foreach($model->classes as $class)
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" {{  in_array( $class->id, $cls ) ? 'checked' : '' }} value="{{$class->id}}" name="classes[]">
                            ...
                            foreach ($advscreens as $sc) {
                             ...
                             ?>
                                        ...
                                        @foreach($screens as $screen)
                                            <div class="form-check">
                                                <input class="form-check-input @error('screens') is-invalid @enderror" type="checkbox" value="{{$screen['id']}}" {{  in_array( $screen['id'], $scs ) ? 'checked' : '' }} name="screens[]">
