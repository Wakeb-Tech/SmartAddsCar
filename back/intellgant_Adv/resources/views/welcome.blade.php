                    ...
                    <div class="col-lg-6 col-md-7">
                        <div class="hero-content">
                            <div class="powered-by">
                                ...
                                <img src="{{asset('images/get-ad-robot.svg')}}" width="50" class="mr-2" class="testim">
        ...
        <footer class="dark-footer">
            ...
            <div class="row">
                <div class="logo col-md-4 ">
                    <a href="index.html"><img src="images/light-wakeb.png" alt="wakeb" title="wakeb"></a>
                </div>
                <div class="col-md-8 cpr">
                    Product powered by Wakeb, All copyrights reserved &copy; 2020
                </div>
            </div>
            </div>
        </footer>
