...
Route::group(['middleware' => ['admin', 'auth'], 'namespace' => 'Admin', 'prefix' => 'admin'], function () {
    ...
    Route::get('get_screen', 'AdminStatisticsController@get_screen')->name('admin.get_screen');
...
Route::group(['middleware' => ['client', 'status', 'auth'], 'namespace' => 'Client', 'prefix' => 'client'], function () {
    ...
    Route::get('get_screen', 'ClientStatisticsController@get_screen')->name('client.get_screen');
